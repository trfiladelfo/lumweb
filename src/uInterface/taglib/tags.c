...
void vInitTagLibrary(void)
{
	...
	xTagList[1].onLoad = vParseIntegerInputField;
	...
	xTagList[1].strFormatter = pcFormatIntegerValue;
	...
	xTagList[4].onLoad = vParseCheckboxInputField;
	...
	xTagList[5].onLoad = vParseHyperlink;
	...
	xTagList[8].onLoad = vParseTimeInputField;
	...
	xTagList[8].strFormatter = pcFormatTimeValue;
	...
	xTagList[9].onLoad = vParseFloatInputField;
	...
	xTagList[9].strFormatter = pcFormatFloatValue;
